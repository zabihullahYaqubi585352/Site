    ...
    return (
        <div className="w-full">
            <div className="fixed top-0 z-[999] w-full border border-b-gray-900 bg-black">
                ...
                <div className="mx-auto flex h-[120px] w-full max-w-[500px] items-center justify-between px-4 py-10 hover:cursor-pointer md:max-w-[800px] lg:max-w-[1000px] xl:max-w-[1200px] 2xl:max-w-[1440px]">
                    ...
                    <div className="flex w-[250px] items-center justify-between">
                        ...
                        {/* <button onClick={() => setOpen(!open)} className="flex items-center gap-2 rounded-md px-4 py-2 text-[#999999]">
                            <img src={getFlagUrl(selected.countryCode)} alt={selected.label} className="h-4 w-5 rounded" />
