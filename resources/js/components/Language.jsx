...
//             <svg onClick={() => setOpen(!open)} xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#999999">
...
//             {open && (
//                 <ul className="absolute left-0 z-10 mt-2 w-48 rounded-md border border-gray-200 bg-white shadow-lg">
//                     {options.map((option) => (
//                         <li
//                             key={option}
