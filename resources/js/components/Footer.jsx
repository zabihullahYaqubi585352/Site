...
const Footer = () => {
    return (
        <div className="scrollbar-webkit relative mt-20 grid w-full grid-cols-1 gap-10 bg-[#0e0e0e]">
            <div className="w-full bg-[url(https://gossip-themes.com/xpovio/wp-content/themes/xpovio/assets/images/footer-bg.png)] py-32">
                <div className="sm: mx-auto grid max-w-[500px] grid-cols-1 gap-8 px-10 py-10 md:max-w-[800px] lg:max-w-[1000px] lg:grid-cols-5 xl:max-w-[1200px] 2xl:max-w-[1440px]">
                    <div className="col-span-2 max-w-[690px]">
                        ...
                        <div className="mt-6 flex flex-row justify-between lg:flex-wrap xl:flex-wrap">
                            <div className="group flex flex-col">
                                <div className="flex items-center gap-2 text-lg text-white group-hover:text-[#2baa8d]">
                                    <svg
                                ...
                                <div className="mt-2 text-lg text-white group-hover:text-[#2baa8d]">Alexandria, USA</div>
                            </div>
                            <div className="group flex text-lg text-white">
                                <div>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        height="15"
                                ...
                                <div className="group-hover:text-[#2baa8d]">(406) 555-0120</div>
                            </div>
                            <div className="group flex text-lg text-white">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div className="group-hover:text-[#2baa8d]">info@xpovio.com</div>
                            </div>
                        </div>
                ...
                <div className="sm: mx-auto flex max-w-[500px] flex-col items-center justify-center gap-10 md:max-w-[800px] lg:max-w-[1000px] lg:flex-row lg:justify-between xl:max-w-[1200px] 2xl:max-w-[1440px]">
                    <div className="text-center text-xl text-gray-500">
                        Copyright © 2024 Xpovio by
                        <span className="mx-1 hover:text-[#2baa8d]">Elegant-Themes</span>. All Rights Reserved.
                    </div>
                    <div className="mx-4 flex items-center gap-2">
                        <div className="flex h-[40px] w-[40px] items-center justify-center rounded-full border border-gray-400 hover:bg-[#2baa8d]">
